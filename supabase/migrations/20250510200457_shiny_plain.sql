/*
  # Enhanced suppliers schema with sample data

  1. New Fields
    - Added detailed supplier information fields
    - Added performance metrics
    - Added product management fields

  2. Sample Data
    - Added initial supplier records
    - Added sample products for each supplier
...
CREATE TABLE IF NOT EXISTS suppliers (
  ...
  performance jsonb DEFAULT '{"on_time_delivery": 0, "quality_rating": 0, "response_rate": 0, "response_time": "0h"}'::jsonb
);
...
-- Add image_urls column separately to ensure it exists
ALTER TABLE supplier_products ADD COLUMN IF NOT EXISTS image_urls text[] DEFAULT ARRAY[]::text[];
