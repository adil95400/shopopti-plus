/*
  # Suppliers and Products Schema Update

  1. New Tables
    - `suppliers` - Base supplier information with extended fields
  ...
  3. Sample Data
    - Add initial supplier records
    - Add sample products for each supplier
*/
...
ALTER TABLE suppliers 
  ...
  ADD COLUMN IF NOT EXISTS performance jsonb DEFAULT '{"on_time_delivery": 0, "quality_rating": 0, "response_rate": 0, "response_time": "0h"}'::jsonb;
